...
def build_config():
    config = {
        ...
        'sequences.unassembled_file': 'data/unassembled_forward.fastq',
        'sequences.assembled_file': 'data/unassembled_reverse.fastq',
        'design_file': 'data/design.csv',

        'sequences_file': 'output/sequences_file.txt',

        'adapter_start_location': [1,35], # 35
        'barcode_location': [36,41], # 6
        ...
        'blast_database_bc_path': "output/blast_database/bc/",
        'blast_db_bc': "output/blast_database/bc/blast_db_bc",
        'blast_db_bc_identifier': "output/blast_database/bc/blast_db_bc_identifier",
        'blast_db_bc_identifier_fasta': "output/blast_database/bc/blast_db_bc_identifier.fasta",
        'blast_db_bc_fasta': "output/blast_database/bc/blast_db_bc.fasta",
        'blast_bc_results': "output/blast_database/bc/blast_bc_results.csv",
        'blast_bc_identifier_results': "output/blast_database/bc/blast_bc_identifier_results.csv",
        'query_results_path': "output/blast_database/bc/query_results.txt",

        'blast_database_seq_design_path': "output/blast_database/seq_design/",
        'blast_db_seq_design': "output/blast_database/seq_design/blast_db_seq_design",
        'blast_db_seq_design_fasta': "output/blast_database/seq_design/blast_db_seq_design.fasta",
        'blast_seq_design_results': "output/blast_database/seq_design/blast_seq_design_results.csv",
        'blast_seq_design_results': "output/blast_database/seq_design/blast_seq_design.csv",
        'query_results_path': "output/blast_database/seq_design/query_results.txt",
